    ...
    <footer className="bg-white text-gray-400 ">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="text-black/75 text-sm mt-0.5">
                Get the best deals and group buy alerts delivered to your inbox.
              </p>
            </div>
            <form
          ...
          {subMsg && (
            <p className="mt-3 text-sm text-white/90 font-medium">{subMsg}</p>
          )}
        </div>
      </div>

      {/* ── Main grid ─────────────────────────────────────── */}
      <div className="max-w-7xl bg-white mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div className="col-span-2 md:col-span-1 space-y-5">
            ...
            <p className="text-sm leading-relaxed">
              Shop together, save together. Discover amazing deals through the
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a
                  href="mailto:hello@collabcart.com"
                  className="hover:text-white transition"
                >
                  hello@collabcart.com
                </a>
              </li>
              <li className="flex items-center gap-2">
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs">
            © {year} CollabCart, Inc. All rights reserved.
          </p>
